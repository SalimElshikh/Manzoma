...
$(document).ready(function () {
    ...
    $('#RotbaQa2edMonawba').change(function () {
        RotbaID = $(this).val();
        Rotba = $("#RotbaQa2edMonawba option:selected").text();
    });
    $('#Qa2edMonawba').change(function () {
        NameQa2edID = $(this).val();
        NameQa2ed = $("#Qa2edMonawba option:selected").text();
    });
...
function updateFardDetails() {
    var rotbaID = $('#RotbaQa2edMonawba').val();
    var we7daID = 3;
    ...
    $.ajax({
        ...
        success: function (data) {
            var fardDetailsDropdown = $('#Qa2edMonawba');
...
function submitAllData() {
    let allData = {
        AnaserMonawba: {
            Qa2edMonawba: NameQa2ed,
            DobatNum: $('#DobatNum').val(),
            DargatNum: $('#DargatNum').val(),
            RotbaQa2edMonawba: Rotba
        },
